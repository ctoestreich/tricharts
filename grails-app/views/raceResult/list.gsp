  ...
  <div class="span9">
    ...
    <table class="table table-striped">
      ...
      <tr>
        ...
        <g:sortableColumn property="race" title="${message(code: 'raceResult.race.label', default: 'Race')}"/>
        ...
        <g:sortableColumn property="user" title="${message(code: 'raceResult.user.label', default: 'User')}"/>
