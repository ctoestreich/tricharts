...
<div class="fieldcontain ${hasErrors(bean: segmentResultsInstance, field: 'placeAgeGroup', 'error')} required">
	<label for="placeAgeGroup">
		<g:message code="segmentResults.placeAgeGroup.label" default="Place Age Group" />
		<span class="required-indicator">*</span>
	</label>
	<g:field type="number" name="placeAgeGroup" required="" value="${fieldValue(bean: segmentResultsInstance, field: 'placeAgeGroup')}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: segmentResultsInstance, field: 'placeOverall', 'error')} required">
	<label for="placeOverall">
		<g:message code="segmentResults.placeOverall.label" default="Place Overall" />
		<span class="required-indicator">*</span>
	</label>
	<g:field type="number" name="placeOverall" required="" value="${fieldValue(bean: segmentResultsInstance, field: 'placeOverall')}"/>
</div>
