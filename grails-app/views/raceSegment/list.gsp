		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<th class="header"><g:message code="raceSegment.race.label" default="Race" /></th>
						
							<th class="header"><g:message code="raceSegment.segment.label" default="Segment" /></th>
				...
				<div class="pagination">
					<bootstrap:paginate total="${raceSegmentInstanceTotal}" />
				</div>
			</div>
