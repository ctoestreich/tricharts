...
<div class="span2"><div id="halfRecord" class="personalBestDiv">
    <div class="btn-group-wrap">
        <h2><a href="javascript:void(0);" class="tooltips" rel="popover" title="${data?.get("'${RaceCategoryType.TenKilometer}'")?.race} @ ${data?.get("'${RaceCategoryType.TenKilometer}'")?.result?.pace}" data-content=""><tri:formatDuration duration="${data?.get("'${RaceCategoryType.TenKilometer}'")?.duration}" /></a></h2>
...
<div class="span2"><div id="halfRecord" class="personalBestDiv">
    <div class="btn-group-wrap">
        <h2><a href="javascript:void(0);" class="tooltips" rel="popover" title="${data?.get("'${RaceCategoryType.TenMile}'")?.race} @ ${data?.get("'${RaceCategoryType.TenMile}'")?.result?.pace}" data-content=""><tri:formatDuration duration="${data?.get("'${RaceCategoryType.TenMile}'")?.duration}" /></a></h2>
