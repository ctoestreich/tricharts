...
<div class="span2"><div id="fivekRecord" class="personalBestDiv">
    <div class="btn-group-wrap">
        <h1><a href="#" class="tooltips" rel="popover" title="${data?.get("'${RaceCategoryType.FiveKilometer}'")?.race} @ ${data?.get("'${RaceCategoryType.FiveKilometer}'")?.result?.pace}" data-content=""><tri:formatDuration duration="${data?.get("'${RaceCategoryType.FiveKilometer}'")?.duration}" /></a></h1>
