	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<fieldset>
					<g:form class="form-horizontal" action="edit" id="${coursePatternLocalMapInstance?.id}" >
						<g:hiddenField name="version" value="${coursePatternLocalMapInstance?.version}" />
						<fieldset>
							<f:all bean="coursePatternLocalMapInstance"/>
