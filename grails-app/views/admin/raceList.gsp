...
<table class="table table-striped">
  ...
  <tr>
    ...
    <g:sortableColumn params="[statusType: statusType]" property="raceCategoryType"
                      title="${message(code: 'race.raceCategoryType.label', default: 'Category')}"/>
    %{--<g:sortableColumn params="[statusType: statusType]" property="statusType"--}%
                      %{--title="${message(code: 'race.statusType.label', default: 'Status')}"/>--}%
  ...
  <g:each in="${raceInstanceList}" var="raceInstance">
    <tr>
      ...
      <td><g:formatDate date="${raceInstance.date}" format="MM/dd/yyyy"/></td>
