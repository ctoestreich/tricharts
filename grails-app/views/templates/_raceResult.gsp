...
<table class="table table-bordered table-striped" data-toggle="collapse" id="table${result.id}">
  <thead>
  <tr>
    <th colspan="${segmentSize}">
      <h4>${result.race.name} ${result.race.date.format("M/dd/yyyy")}</h4></th>
  </tr>
  </thead>
  <tbody>
  <tr>
