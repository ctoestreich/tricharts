<div class="row-fluid">
    ...
    <div class="span8">
        <div class="btn-group-wrap-right">
            <div class="btn-group">
                <a class="btn"
                   href="${createLink(controller:'dashboard', action:'progression', params: [raceType:sport])}"
                   id="view-progression"><i class="icon-camera"></i>&nbsp;${sport} Charts</a>
                <a class="btn"
                   href="${createLink(controller: 'dashboard', action: 'createResult', params: [raceType: sport])}"
