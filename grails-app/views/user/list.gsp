				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<g:sortableColumn property="athlinkRacerId" title="${message(code: 'user.athlinkRacerId.label', default: 'Athlink Racer Id')}" />
					...
					<g:each in="${userInstanceList}" var="userInstance">
						<tr>
							...
							<td>${fieldValue(bean: userInstance, field: "athlinkRacerId")}</td>
